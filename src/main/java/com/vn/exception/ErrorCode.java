...
public enum ErrorCode {
    ...
    INVALID_VERIFICATION_CODE(HttpStatus.BAD_REQUEST, "INVALID_VERIFICATION_CODE", "Mã xác thực không đúng"),
    VERIFICATION_CODE_EXPIRED(HttpStatus.BAD_REQUEST, "VERIFICATION_CODE_EXPIRED", "Mã xác thực đã hết hạn, vui lòng yêu cầu mã mới"),
    EMAIL_VERIFICATION_ATTEMPT_LIMIT_EXCEEDED(HttpStatus.TOO_MANY_REQUESTS, "EMAIL_VERIFICATION_ATTEMPT_LIMIT_EXCEEDED", "Bạn đã nhập sai mã quá nhiều lần, vui lòng yêu cầu mã mới"),
